...
public class DataDemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Adding Students on startup
		boolean fullTime = true;
		studentRepository.save(new Student(new Person("John", "Doe"), fullTime, 20));
		studentRepository.save(new Student(new Person("Jane", "Doe"), fullTime, 22));
		studentRepository.save(new Student(new Person("Mike", "Smith"), fullTime, 18));
		studentRepository.save(new Student(new Person("Allen", "Kim"), !fullTime, 19));

		// Adding Staff on startup
